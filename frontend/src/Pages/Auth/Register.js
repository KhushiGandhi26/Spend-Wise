  ...
  return (
    ...
    <div style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      <Row>
        ...
        <h1 className="text-center text-black">Welcome to Spend-Wise</h1>
        <Col md={{ span: 6, offset: 3 }}>
          ...
          <Form>
            ...
            <div style={{width: "100%", display: "flex" , alignItems:"center", justifyContent:"center", flexDirection: "column"}} className="mt-4">
              ...
              <p className="mt-3" color={{color: "#343a40"}}>Already have an account? <Link to="/login" className="text-black lnk" >Login</Link></p>
            </div>
          </Form>
        </Col>
      </Row>
